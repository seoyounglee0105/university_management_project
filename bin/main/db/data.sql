...
VALUES
	('상하수도공학','23000001','c201',101,'전공','2022',1,'금요일 10:00',3,30),
	('응용역학','23000001','c201',101,'전공','2022',1,'금요일 11:00',3,30),
	('측량학','23000001','c201',101,'전공','2022',1,'금요일 12:00',3,30),
	('수리학','23000001','c201',101,'전공','2022',1,'금요일 14:00',3,30),
	('철근콘크리트 및 강구조','23000001','c201',101,'전공','2022',1,'금요일 16:00',3,30),
	('토질 및 기초','23000001','c201',101,'전공','2022',1,'금요일 18:00',3,30),
	('영어','23000002','c201',101,'교양','2022',1,'토요일 10:00',3,30),
    ('미술','23000002','c201',101,'교양','2022',1,'토요일 11:00',3,30),
    ('상하수도공학','23000001','c202',101,'전공','2022',2,'금요일 10:00',3,30),
	('응용역학','23000001','c202',101,'전공','2022',2,'금요일 11:00',3,30),
	('측량학','23000001','c202',101,'전공','2022',2,'금요일 12:00',3,30),
	('수리학','23000001','c202',101,'전공','2022',2,'금요일 14:00',3,30),
	('철근콘크리트 및 강구조','23000001','c202',101,'전공','2022',2,'금요일 16:00',3,30),
	('영어','23000002','c202',101,'교양','2022',2,'토요일 10:00',3,30),
    ('토질 및 기초','23000001','c202',101,'전공','2022',2,'금요일 18:00',3,30),
    ('미술','23000002','c202',101,'교양','2022',2,'토요일 11:00',3,30),
